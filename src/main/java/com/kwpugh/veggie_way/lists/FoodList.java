...
{	
	...
	public static Food energyDrink = (new Food.Builder()).hunger(8).saturation(0.5F).setAlwaysEdible().fastToEat().build();
	public static Food superfoodShake = (new Food.Builder()).hunger(10).saturation(0.75F).setAlwaysEdible().fastToEat().build();
	public static Food superfoodSmoothie = (new Food.Builder()).hunger(10).saturation(0.75F).setAlwaysEdible().fastToEat().build();
