	...
	public static class RegistryEvents
	{
		...
		public static void registerItems(final RegistryEvent.Register<Item> event)
		{
			...
			(				
				...
				ItemList.energy_drink = new Item(new Item.Properties().food(FoodList.energyDrink).group(VeggieWay.veggie_way)).setRegistryName(location("energy_drink")),
				ItemList.superfood_shake = new Item(new Item.Properties().food(FoodList.superfoodShake).group(VeggieWay.veggie_way)).setRegistryName(location("superfood_shake")),
				ItemList.superfood_smoothie = new Item(new Item.Properties().food(FoodList.superfoodSmoothie).group(VeggieWay.veggie_way)).setRegistryName(location("superfood_smoothie")),
