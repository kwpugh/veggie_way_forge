...
public class ItemInit
{
	...
	public static final RegistryObject<Item> HAND_SCRAPER = ITEMS.register("hand_scraper", () -> new ItemHandScraper(new Item.Properties().maxStackSize(1).maxDamage(192).setNoRepair().group(VeggieWay.veggie_way)));
