...
public class BlockInit
{
	...
	public static final RegistryObject<Block> PLANT_COTTON = BLOCKS.register("plant_cotton", () -> new PlantCotton("plant_cotton", Block.Properties.of(Material.PLANT).noCollission().randomTicks().strength(0.0f, 0.0f).sound(SoundType.CROP)));
}
