...
public class BlockInit
{
	...
	public static final RegistryObject<Block> PLANT_LENTIL = BLOCKS.register("plant_lentil", () -> new PlantLentil("plant_lentil", Block.Properties.create(Material.PLANTS).doesNotBlockMovement().tickRandomly().hardnessAndResistance(0.0f, 0.0f).sound(SoundType.CROP)));
	public static final RegistryObject<Block> PLANT_CORN = BLOCKS.register("plant_corn", () -> new PlantCorn("plant_corn", Block.Properties.create(Material.PLANTS).doesNotBlockMovement().tickRandomly().hardnessAndResistance(0.0f, 0.0f).sound(SoundType.CROP)));
}
